  ...
  return (
    <section className="relative overflow-hidden py-8 sm:py-12">
      <div className="container-shell">
        {/* Emitting the markup here keeps BreadcrumbList in lockstep with the trail users actually see. */}
        ...
        <div className="rounded-3xl border border-white/80 bg-white/80 p-6 shadow-card backdrop-blur-sm sm:p-10">
          <h1 className="max-w-4xl font-display text-3xl font-semibold tracking-tight text-brand-navy sm:text-5xl">{title}</h1>
